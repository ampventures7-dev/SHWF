...
def prepare_template_context(
    ...
    return {
        ...
        "dietitian_advice_line1": advice_line1,
        "dietitian_advice_line2": advice_line2,
        ...
        "clinical_opinion_line2": "Adhere to the recommended dietary modifications and hydration guidelines.",
...
async def generate_report_pdf_async(
    ...
    try:
        ...
        raise RuntimeError(f"Playwright PDF conversion error: {str(e)}") from e
...
def generate_report_pdf(
    ...
    try:
        ...
        logger.error(f"Playwright sync PDF generation failed: {str(e)}")
        raise RuntimeError(f"Playwright PDF conversion error: {str(e)}") from e
